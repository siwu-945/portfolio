...
import { getAllFilesFrontMatter, getAllProjectsFrontMatter } from '@/lib/mdx'
...
// export const getStaticProps2: GetStaticProps<{ projects: ProjectFrontMatter[] }> = async () => {
    ...
    <>
      ...
      {/* <div className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <ul className="divide-y divide-gray-200 dark:divide-gray-700">
          ...
          {projects.slice(0, MAX_DISPLAY).map((frontMatter) => {
            ...
            return <Card {...frontMatter} key={title} />
          })}
        </ul>
      </div>
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        <div className="space-y-2 pb-8 pt-6 md:space-y-5">
          ...
          <p className="text-lg leading-7 text-gray-500 dark:text-gray-400">Just some thoughts</p>
        </div>
        <ul className="divide-y divide-gray-200 dark:divide-gray-700">
